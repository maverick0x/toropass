...
| `GET /api/v1/conscents/:userId` | List connected apps | `x-api-key` + JWT + HMAC | Not implemented |
| `DELETE /api/v1/conscents/:userId/:appId` | Revoke consent | `x-api-key` + JWT + HMAC | Not implemented |
